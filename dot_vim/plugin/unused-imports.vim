...
" Assign :UI and :UIR to highlight unused imports and remove unused imports respectively
command! UI call s:highlight_unused_imports(0)
command! UIR call s:highlight_unused_imports(1)
